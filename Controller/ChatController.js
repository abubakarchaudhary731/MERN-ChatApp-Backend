...
const renameGroup = asyncHandler(async (req, res) => {
    ...
    if (!updatedGroupName) {
        ...
        return res.status(200).json({ message: "Group Name Update Successfully", data: updatedGroupName });
    }
});
...
const addToGroup = asyncHandler(async (req, res) => {
    ...
    // Find the chat to check if the user is already a member
    ...
    if (!added) {
        ...
        return res.status(200).json({ message: "User added to group successfully", data: added });
    }
});
...
const removeFromGroup = asyncHandler(async (req, res) => {
    ...
    if (!removed) {
        ...
        return res.status(200).json({ message: "User removed from group successfully", data: removed });
    }
});
